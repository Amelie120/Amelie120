...
- 🔗 Independent Solidity smart contracts
- 🧪 Foundry projects, tests and deployment scripts
- ☕ Java data structures and algorithms practice
- 💻 The [Opino](https://opino.io/) SaaS platform
- 🌐 A growing blockchain and Web3 portfolio
...
|---|---|---|
| [💗 Solidity Practice](https://github.com/Amelie120/Solidity-practice) | Independent smart contracts written while learning Ethereum development | Solidity, Ethereum |
| [₿ Bitcoin Price Data](https://github.com/Amelie120/Bitcoin-price-data) | Processes Bitcoin market data and displays an interactive candlestick chart | Python, pandas, Plotly |
| [🤖 SimpleChatApp](https://github.com/Amelie120/SimpleChatApp) | A conversational AI application built using LangChain | Python, LangChain |
| [💌 Email Parser](https://github.com/Amelie120/Email-parser) | Extracts, cleans and structures Gmail message content | Python, IMAP |
| [☕ Java DSA Practice](https://github.com/Amelie120/java-dsa-practice) | Java data structures, algorithms and interview preparation | Java, DSA |
...
- 🌐 TypeScript and Web3 frontend development
...
Outside software development, I enjoy:

- 💬 Long conversations about blockchain and emerging technologies
